...
public class NoticiasAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<Noticias> modelList;

    private OnItemClickListener mItemClickListener;


    public NoticiasAdapter(Context context, ArrayList<Noticias> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<Noticias> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final Noticias model = getItem(position);
    ...
    private Noticias getItem(int position) {
        return modelList.get(position);
    }


    public interface OnItemClickListener {
        void onItemClick(View view, int position, Noticias model);
    }
