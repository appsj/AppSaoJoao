...
import com.group.uni.sojoo2018.activities.telaApresentacao.utils.ShadowTransformer;

import java.util.List;

public abstract class ApresentacaoActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {

    private CircleIndicatorView circleIndicatorView;
    private ViewPager vpOnboarderPager;
    private ApresentacaoAdapter apresentacaoAdapter;
    ...
    private List<ApresentacaoCard> pages;
    ...
    public void setOnboardPages(List<ApresentacaoCard> pages) {

        this.pages = pages;
        apresentacaoAdapter = new ApresentacaoAdapter(pages, getSupportFragmentManager(), dpToPixels(0, this), typeface);
        mCardShadowTransformer = new ShadowTransformer(vpOnboarderPager, apresentacaoAdapter);
        mCardShadowTransformer.enableScaling(true);
        vpOnboarderPager.setAdapter(apresentacaoAdapter);
    ...
    public void onClick(View v) {
        ...
        boolean isInLastPage = vpOnboarderPager.getCurrentItem() == apresentacaoAdapter.getCount() - 1;
    ...
    public void onPageSelected(int position) {
        ...
        int lastPagePosition = apresentacaoAdapter.getCount() - 1;
